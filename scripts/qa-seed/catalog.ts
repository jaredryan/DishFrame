export function printCatalog(input: {
  ...
  const lines = [
    ...
    "",
    "Nutrition:",
    "  Whole-Dish manual override/WHOLE/primary-only: [QA] All-Purpose Seasoning Blend",
    "  Whole-Dish manual override/PER_OUTPUT_UNIT/primary+more: [QA] Peanut Dipping Sauce",
    "  Whole-Dish USDA FDC override (non-branded): [QA] Cauliflower Rice",
    "  Whole-Dish USDA FDC override (branded-style): [QA] Garlic Confit",
    "  Whole-Dish manual override/WHOLE/detached-no-source: [QA] Weeknight Stir-Fry",
    "  No nutrition anywhere: [QA] Steamed White Rice",
    "  Ingredient-level calculated + Section override (mixed Partial/Manual override): [QA] Simple Garden Salad",
    "    Salad section: 2 of 3 ingredients have nutrition (Partial); Dressing section: Section-level override",
    "  Nested-Part version pinning: [QA] Peanut Noodle Salad and [QA] Rice Side Dish link [QA] Peanut Dipping Sauce at its older pinned Version (no nutrition data there — contributes nothing, correctly resolved from that exact pinned Version, not Sauce's current one, which does have nutrition). [QA] Weeknight Stir-Fry links Sauce's current Version instead, but its own whole-Dish override masks the composition (replaces rather than sums it in).",
    "",
