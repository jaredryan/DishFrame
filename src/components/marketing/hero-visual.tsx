...
export function HeroVisual({ className }: { className?: string }) {
  return (
    <div
      ...
      role="img"
      aria-label="An example recipe card showing Sauce, Rice, Chicken, and Finish sections, with a saved-part marker, a version marker, and a note from a previous meal."
    >
      {/* Version marker */}
      ...
      <div className="border-border bg-card absolute -bottom-4 -left-4 z-20 hidden w-44 -rotate-2 rounded-xl border p-3 shadow-md sm:block">
