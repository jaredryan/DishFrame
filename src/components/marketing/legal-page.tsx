...
export function LegalLayout({
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div
        className="border-border mt-12 flex flex-col gap-10 border-t pt-12
          [&_h2]:font-heading [&_h2]:text-foreground [&_h2]:text-xl [&_h2]:font-semibold
          [&_p]:text-muted-foreground [&_p]:mt-3 [&_p]:leading-relaxed [&_p]:text-pretty
          [&_ul]:mt-3 [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-1.5
          [&_li]:text-muted-foreground [&_li]:ml-5 [&_li]:list-disc [&_li]:leading-relaxed
